...
class DjangoUploadFile_admin(admin.ModelAdmin):
    list_display=('username','headimg','created_at')
    list_filter=('created_at',)

admin.site.register(models.DjangoUploadFile,DjangoUploadFile_admin)
